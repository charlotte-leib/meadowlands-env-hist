...
const SchuylersMansion = L.marker([40.7879, -74.1364]).bindPopup('<h5>Schuyler Mansion</h5><p>Ben Franklin visited the Schuylers in 1743 and recommended the Schuylers purchase a steam engine to aid in the extraction of copper in the nearby Schuyler mine.</p><a href="/meadowlands-env-hist/meadowworlds/artifact_earlyam_schuylermine_1/"><img src="/meadowlands-env-hist/img/derivatives/iiif/images/artifact_earlyam_schuylermine_1/full/full/0/default.jpg"</a>').addTo(landscapefeatures);
